...
import { Grid, List, MessageSquare, Heart, Eye, Trash2, PenSquare } from 'lucide-react';
...
export default function UserDashboard() {
  ...
  // Simuler les annonces de l'utilisateur
      ...
      <div className="flex-1 p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            {[
              { label: 'Annonces actives', value: userAds.filter(ad => ad.status === 'active').length },
              { label: 'En attente', value: userAds.filter(ad => ad.status === 'pending').length },
              { label: 'Vendus', value: userAds.filter(ad => ad.status === 'sold').length },
